...
down_revision: str | Sequence[str] | None = "2e3987712977"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["product_id"],
            ["products.id"],
            name=op.f("fk_product_tag_product_id_products"),
        ),
        sa.ForeignKeyConstraint(
            ["tag_id"], ["tags.id"], name=op.f("fk_product_tag_tag_id_tags")
        ),
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        op.f("fk_products_category_id_categories"), "products", type_="foreignkey"
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "product_id", "category_id", name=op.f("pk_product_categories")
        ),
    )
