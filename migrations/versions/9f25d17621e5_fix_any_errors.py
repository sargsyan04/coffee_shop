...
down_revision: str | Sequence[str] | None = "043bf94f90e4"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "token_type",
            sa.Enum(
                "EMAIL_CONFIRMATION", "PASSWORD_RESET", name="verificationtokentype"
            ),
            nullable=False,
        ),
        sa.Column("expires_at", sa.DateTime(timezone=True), nullable=False),
        ...
        sa.Column("id", sa.BIGINT(), nullable=False),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_verification_tokens_user_id_users")
        ),
    ...
    op.add_column(
        ...
        sa.Column(
            "role",
            sa.Enum("CUSTOMER", "BARISTA", "ADMIN", name="userrole"),
            nullable=False,
        ),
    )
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["order_id"], ["orders.id"], name=op.f("fk_orderitems_order_id_orders")
        ),
        sa.ForeignKeyConstraint(
            ["product_id"],
            ["products.id"],
